...
with DAG(
    ...
    ingest_task = KubernetesPodOperator(
        ...
        image="ghcr.io/viniciusmarchi/data-ingestion-task:latest",
    ...
    data_preparation_task = KubernetesPodOperator(
        ...
        image="ghcr.io/viniciusmarchi/data-preparation-task:latest",
    ...
    train_task = KubernetesPodOperator(
        ...
        image="ghcr.io/viniciusmarchi/train-task:latest",
